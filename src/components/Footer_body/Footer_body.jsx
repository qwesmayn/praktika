import s from './Footer_body.module.css'
    ...
    return (
        <div className={s.Footer}>
            <div className={s.logo_info}>
                ...
                <p className={s.text_info2}>Разработка сайта — Новый сайт</p>
                <p className={s.text_info2}>Политика конфиденциальности</p>
            </div>
            <div className={s.contacts}>
                <div className={s.contact_text}>Контакты</div>
                <div className={s.contacts_info}>
                    <div className={s.adres}>
                        <p className={s.contacts_info_text}>АДРЕС:</p>
                        <p className={s.contacts_info_text}>г. МИНСК, ПАРТИЗАНСКИЙ ПРОСПЕКТ 19А</p>
                    </div>
                    <div className={s.number_i_}>
                        <div className={s.number}>
                            <p className={s.contacts_info_text}>Тел:</p>
                        ...
                        <div className={s.email}>
                            <p className={s.contacts_info_text}>E-MAIL:</p>
