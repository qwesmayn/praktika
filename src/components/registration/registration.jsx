                ...
                <div className={s.input_data}>
                    <div className={s.info_all}>
                        ...
                        <div className={s.info2}>
                            <NavLink to='/' className={navData => navData.isActive ? s.active : s.item}>Вернуться на главную</NavLink> 
                        </div>
                    </div>
                    <div>
                    ...
                    <div className={s.end}>
                        <NavLink to='/login' className={navData => navData.isActive ? s.active : s.item}>Уже зарегестрированы?</NavLink>
