...
export default function Contact() {
    const [modal_Active, setModalActive] = useState()
    return (
                ...
                <div className={Style.contact_about}>
                    ...
                    <div className={Style.block_consult}>
                        ...
                        <div className={Style.form_question}>
                            ...
                            <button className={Style.btn_send} onClick={() => setModalActive(true)}>ОТПРАВИТЬ</button>
                        </div>
                    </div>
                </div>
            </main>
            <Modal_window active={modal_Active} setActive={setModalActive} >
                <p>Ваша заявка будет обработана в течении 10-15 минут</p>
            </Modal_window>
        </div>
